...
Oc ces informations sont dans le titre des colonnes de notre tableau.  Pour changer le format et créer une colonne qui contient l'information du titre des colonnes, nous devons utiliser la fonction `gather()`
-------
