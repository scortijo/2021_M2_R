...
Tout d'abord, nous allons créer un `projet R` qui contiendra tous nos scripts et leurs sorties. Pour cela allez dans *file* puis selectionnez *New Project...*. Indiquez que vous voulez créer le projet dans un *Existing Directory*, choisissez le dossier contenant le cours (*2021_M2_R*) et cliquez sur *Create Project*. Cela va créer  `2021_M2_R.Rproj` qu'il vous suffit d'ouvrir la prochaine fois pour avoir accés à votre projet R dans Rstudio. 
